...
//
// Google sign-up uses the In-App Browser OAuth workflow via the official
...
//
// Manual email/password account creation is handled by handleSignUp().
...
// ── In-App Browser Google Sign Up ─────────────────────────
// Opens the backend's Google OAuth start endpoint inside the in-app browser.
// The backend creates the account if it doesn't exist, then redirects back to
// the app via a deep link handled by the appUrlOpen listener below.
...
document.addEventListener('DOMContentLoaded', () => {
  // Bind the in-app browser Google sign-up to the "Continue with Google" button
